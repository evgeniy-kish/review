...
@section('title', 'Темы FAQ')
@section('description', 'Темы FAQ')

@section('content')
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Темы</h3>
            </div>
        </div>
    </div>
                            ...
                            <div id="editable" class="nk-tb-list nk-tb-ulist">
                                ...
                                @foreach($subjects as $subject)
                                    <div class="nk-tb-item">
                                        ...
                                        <div class="nk-tb-col tb-col-sm"><span>{{ $subject->slug }}</span></div>
                                        <div class="nk-tb-col">
                                            <div><span>{{ $subject->questions->count() }}</span></div>
                                        </div>
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1" data-info="{{ $subject }}">
                                                <li class="nk-tb-action-hidden">
                                                    <a href="#" class="btn btn-trigger btn-icon edit-subject" data-toggle="tooltip" data-placement="top" title="Редактировать">
                                                        <em class="icon ni ni-edit-fill"></em>
                                                    </a>
                                                </li>
                                                <li class="nk-tb-action-hidden">
                                                    <a href="#" class="btn btn-trigger btn-icon delete-subject" data-toggle="tooltip" data-placement="top" title="Удалить">
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li>
                                                                    <a href="#" class="edit-subject"><em class="icon ni ni-edit-fill"></em><span>Редактировать</span></a>
                                                                </li>
                                                                <li>
                                                                    <a href="#" class="delete-subject"><em class="icon ni ni-trash-fill"></em><span>Удалить</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <div class="col-md-6">
                <div class="card card-bordered">
                    <div class="card-inner">
                        <form class="crutch-validate is-alter" action="{{ route('panel.faq.subjects.store') }}" method="post">
                            ...
                            <div class="form-group mt-2">
                                <button type="submit" class="btn btn-lg btn-primary">Добавить тему</button>
                            </div>
...
@section('modal')
    <div class="modal fade" tabindex="-1" role="dialog" id="edit-subject">
...
@push('script')
    ...
    <script>
      $(function () {
        ...
        const modal = $('#edit-subject');

        editable.on('click', '.edit-subject', function (e) {
          e.preventDefault();
          const data = $(this).closest('ul.nk-tb-actions').data('info');

          modal
            .find('form').attr('action', '/panel/faq/subjects/' + data.id + '/edit').end()
        ...
        editable.on('click', '.delete-subject', function (e) {
          e.preventDefault();
          const data = $(this).closest('ul.nk-tb-actions').data('info');
          ...
          Swal.fire({
            ...
            preConfirm: function () {
              return $.post('/panel/faq/subjects/' + data.id + '/delete', {}, null, 'json')
                .then(function (json) {
